...
def _main():
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
                # freeze_body=2, weights_path=log_dir + 'trained_weights_stage_1.h5')
        #    freeze_body=2, weights_path='/credera/jds-arx-poc/src/shoe-detection/keras-training-files/model_data/initial_shoe_detection_weights.h5') # make sure you know what you freeze
